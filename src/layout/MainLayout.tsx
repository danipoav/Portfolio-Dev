    ...
    return (
        <CursorLight>
            <div className="md:flex md:h-screen">
                <div className="md:w-1/2 md:fixed md:left-0 md:top-0 md:h-screen bg-gray-900 text-white p-6">
                    <div className="fixed bottom-0 left-0 md:left-20 border border-white h-25" />
                    <LeftSide />
                </div>
                <div className="md:w-1/2 md:ml-auto md:h-screen md:overflow-y-scroll md:p-6 bg-gray-900 text-white">
                    <div className="fixed bottom-0 right-0 md:right-20 border border-white h-25" />
                    <RightSide />
                </div>
            </div>
        </CursorLight>
